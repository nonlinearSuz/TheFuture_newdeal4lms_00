package kr.happyjob.study.supMya.dao;
...
public interface SupMyaDao {

   /** 목록 조회 */
   public List<EnrollModel> myLecturelist(Map<String, Object> paramMap);
   
   /** 목록 카운트 조회 */
   public int countmyLecturelist(Map<String, Object> paramMap);
