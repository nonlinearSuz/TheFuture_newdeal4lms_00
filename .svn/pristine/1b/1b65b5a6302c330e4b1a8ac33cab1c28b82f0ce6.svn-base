package kr.happyjob.study.supass.dao;
...
public interface SupassDao {
	...
	int assignTeacherInsertFile(Map<String, Object> paramMap)throws Exception;

	int assignTeacherUpdateFile(Map<String, Object> paramMap)throws Exception;
	...
	int assignStudentInsertFile(Map<String, Object> paramMap) throws Exception;

	int assignStudentUpdateFile(Map<String, Object> paramMap)throws Exception;
