  ...
  <div class="logo">
    <div id="header">
      <a class="logo" href="/dashboard/dashboard.do"> 
      		<img src="/images/admin/login/logo.png" alt="메인페이지" /></a>
    </div>  
  </div>
  <div class="login" style="position:relative;">
	    <img src="/images/admin/comm/left_myImg.jpg" class="LoginImg" alt="사진" style="display: block; margin: 0 auto;  opacity: 0.3;"/>
	    <span     style="  margin-top:5px;  display: block;" class="LoginName">${sessionScope.userNm}</span>
	    
	<!--     <span><a href="" style="color:white; position:absolute; left: 15px; bottom:0;">[마이페이지]</a></span> -->
